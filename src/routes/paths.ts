...
export const paths = {
  ...
  dashboard: {
    ...
    audit: {
      ...
      new: `${ROOTS.DASHBOARD}/audit/new`,
      list: `${ROOTS.DASHBOARD}/audit/list`,
      details: (id: string) => `${ROOTS.DASHBOARD}/audit/${id}/details`,
      edit: (id: string) => `${ROOTS.DASHBOARD}/audit/${id}/edit`,
    },
    auditAns: {
      root: `${ROOTS.DASHBOARD}/audit-ans`,
      list: `${ROOTS.DASHBOARD}/audit-ans/list`,
      edit: (id: string) => `${ROOTS.DASHBOARD}/audit-ans/${id}/fill`,
    },
    user: {
