...
import { useGetSingleAudit } from '../audit-ans/api/audit';

import type { IAuditData } from '../audit-ans/api/types';
...
export function AuditSummeryPage({ currentAuditTemplate }: Props) {
